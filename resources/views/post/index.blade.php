            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('post.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="title" style="background-color: #f5f7fa; color: #222831;" value="{{ old('title') }}" placeholder="Enter your title" required> <!-- Light input -->
                    </div>

                    <div class="mb-3">
                        <label for="content" class="form-label" style="color: #8892b0;">Content</label>
                        <textarea class="form-control" id="content" name="content" rows="5" style="background-color: #f5f7fa; color: #222831;" placeholder="Enter content" required>{{ old('content') }}</textarea> <!-- CKEditor will replace this -->
                    </div>
                    <!-- Submit Button -->
